            ...
            @if($stock == 1)
                <li>
                    <span class="input">
                        ...
                        <input type="text" name="grids[qty]" id="entry-{{$key}}"  autocomplete="off" value="{{$qty}}" maxlength="4" class="input-unstyled input-sep" style="width: 50px;">
                    ...
                    <div class="button-group absolute-right compact">
                        <a class="button icon-trash with-tooltip red-gradient confirm" title="{{$key}}"></a>
                    </div>
                </li>
            @else
