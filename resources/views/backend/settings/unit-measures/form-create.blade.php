<div id="modal-unit-measures">
	<form id="form-unit-measures" method="POST" action="{{route('units-measures.store')}}" onsubmit="return false">
		@csrf
			...
			<p class="button-height inline-label">
				...
				<span class="number input">
					<button type="button" class="button number-down">-</button>
						<input type="text" id="unit" name="unit" value="" size="4" class="input-unstyled" data-number-options='{"min":0,"max":100,"increment":0.5,"shiftIncrement":5,"precision":0.25}'>
