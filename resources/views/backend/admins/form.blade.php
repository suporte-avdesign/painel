<div id="modal-admins">
@if(isset($data))
	<form id="form-admins" method="POST" action="{{route('usuarios.update', $data->id)}}" onsubmit="return false">
		<input name="_method" type="hidden" value="PUT">
		<input name="has" type="hidden" value="{{$code}}">
@else
	<form id="form-admins" method="POST" action="{{route('usuarios.store')}}" onsubmit="return false">
@endif
	{{csrf_field()}}
