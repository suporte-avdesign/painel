<div id="modal-accounts">
	<form id="form-accounts" method="POST" action="{{route('clientes.update', $data->id)}}" onsubmit="return false">
			...
			<p class="button-height inline-label">
				...
				<span class="button-group">
					<label for="status-1" class="button blue-active">
						<input type="radio" name="user[status]" id="status-1" value="1" @if($data->status == 1) checked @endif>
						Ativo
					</label>
					<label for="status-0" class="button red-active">
						<input type="radio" name="user[status]" id="status-0" value="0" @if($data->status == 0) checked @endif>
						Inativo
					</label>
				</span>
			</p>
			<p class="button-height inline-label">
				...
				<span class="button-group">
					<label for="newsletter-1" class="button blue-active">
						<input type="radio" name="user[newsletter]" id="status-1" value="1" @if($data->newsletter == 1) checked @endif>
						Ativo
					</label>
					<label for="newsletter-0" class="button red-active">
						<input type="radio" name="user[newsletter]" id="status-0" value="0" @if($data->newsletter == 0) checked @endif>
						Inativo
					</label>
				</span>
			</p>
