<div class="block-title">
    ...
    <div class="button-group absolute-right">
        @can('contact-update')
            <a href="contatos" class="button icon-mail margin-left blue-gradient glossy ">Contatos</a>
        @endcan
    </div>
</div>
...
<script src="{!! url('assets/backend/scripts/spams.js?'.time()) !!}"></script>
<script>
        ...
        <div class="panel-load-target scrollable" style="height:490px">
            <div class="navigable">
                <ul class="files-list mini open-on-panel-content">
                    @can('contact-send')
                        <li>
                            <a href="spam/mensagem/@{{{id}}}" class="file-link">
                    ...
                    @can('contact-view')
                        <li>
                            <a href="spam/@{{{id}}}/detalhes" class="file-link">
