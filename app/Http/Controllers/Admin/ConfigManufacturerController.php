...
use AVDPainel\Interfaces\Admin\ConfigManufacturerInterface as InterModel;
use AVDPainel\Http\Controllers\Controller;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Gate;

class ConfigManufacturerController extends Controller
{

    protected $ability  = 'config-manufacturer';
    protected $view     = 'backend.config.images.manufacturers';
    protected $last_url;
    protected $messages;
    ...
    public function edit()
    {
        ...
        $this->last_url = array("last_url" => "config/imagens/fabricantes");
