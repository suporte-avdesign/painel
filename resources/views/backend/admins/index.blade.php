...
<script src="{!! url('assets/backend/scripts/admins.js?'.time()) !!}"></script>
<script>
            ...
            <div class="panel-load-target scrollable" style="height:490px">
                <div class="navigable">
                    <ul class="files-list mini open-on-panel-content">
                        ...
                        @can('model-admins-create')
                            <li>
                                <a href="usuario/@{{{id}}}/foto-admin" class="file-link">
                        ...
                        <li>
                            <div class="button-group absolute-right compact">
                                @can('model-admins-delete')
                                    <button id="btn-excluir" onclick="deleteAdmin('usuarios/@{{{id}}}', '@{{{name}}}');" class="button icon-trash with-tooltip red-gradient" title="Excluir Usuário">Excluir
                                    </button>
                                @endcan
                                @can('model-admins-update')
                                    <button id="btn-editar" onclick="abreModal('Alterar Usuário: @{{{name}}}', 'usuarios/@{{{id}}}/edit', 'dados-usuarios', 2, 'true', 400, 500);" class="button blue-gradient icon-pencil with-tooltip" title="Alterar Usuário">Editar
                                    </button>
                                @endcan
                            </div>
                        </li>
