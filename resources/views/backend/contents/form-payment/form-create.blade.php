<div id="modal-contents">
    <form id="form-contents" method="POST" action="{{route('form-payment.store')}}" onsubmit="return false">
        ...
        <fieldset class="fieldset">
            ...
            <p class="button-height block-label">
                ...
                <textarea id="payment-create" rows="2" name="description" class="input full-width"></textarea>
            </p>
            ...
            <p class="button-height align-center">
                <span class="button-group">
                    ...
                    @can('contents-site-create')
                        <button id="btn-modal" onclick="formContents('create', 'contents', '{{route('form-payment.load')}}')" class="button blue-gradient">
...
<script>
    CKEDITOR.replace( 'payment-create', {
        height: 150,
        language: 'pt-br'
    });
</script>
