...
use AVDPainel\Interfaces\Admin\ContentDeliveryInterface as InterModel;
...
{
    protected $content = 'Conteúdo: Sobre Entregas';
    protected $ability = 'contents-site';
    protected $view    = 'backend.contents.delivery';
    protected $model;
