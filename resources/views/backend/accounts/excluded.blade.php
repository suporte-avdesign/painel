<div class="block-title">
    ...
    <div class="button-group absolute-right">
        @can('account-view')
            <a href="clientes" class="button icon-users margin-left blue-gradient glossy ">Clientes Cadastrados</a>
        @endcan
    </div>
</div>
<!-- DataTables -->
...
<script src="{!! url('assets/backend/scripts/accounts-excludeds.js?'.time()) !!}"></script>
<script>
