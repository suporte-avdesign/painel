<div id="modal-status-payments">
	<form id="form-status-payments" method="POST" action="{{route('status-payments.store')}}" onsubmit="return false">
		@csrf
			...
			<p class="button-height align-center">
				<span class="button-group">
					...
					@can('config-status-payments-create')
						<button id="btn-modal" onclick="formStatusPayments('create', 'status-payments','{{route('status-payments.show', 1)}}')" class="button blue-gradient">
