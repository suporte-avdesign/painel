...
;(function($, undefined)
{
    ...
    {  
        ...
        */
         ...
         */
        plusUndBrand = function () {
            $("#plus-unit").append('<span class="puls_grid input margin-right">'+
                '<input type="text" name="label[]" value="" size="4" class="input-unstyled">'+
                '<button onclick="removeGridBrand(this,\'.puls_grid\');" class="remove-unit button red-gradient icon-minus" title="'+tableBrand.texDelete+'"></button>'+
                '</span>');
        }
         ...
         * Adicionar input kit
         */
        plusKitBrand = function(){
            $("#plus-kit").append('<p class="puls_grid button-height inline-small-label">'+
                '<span class="input">'+
                '<input type="text" name="qty[]" class="amount input-unstyled input-sep" placeholder="'+tableBrand.texQty+'" value="0" maxlength="3" style="width: 30px;">'+
                '<input type="text" name="des[]" class="input-unstyled" placeholder="'+tableBrand.txtDesc+'" value="" style="width: 80px;">'+
                '<button onclick="removeGridBrand(this,\'.puls_grid\')" class="remove button red-gradient icon-minus" title="'+tableBrand.texDelete+'"></button>'+
                '</span>' +
                '</p>');
            sumGridsBrand();
        }
         ...
         * Remover input Unit
         */
        removeGridBrand = function(_this, id) {
         ...
         *  Form grids
         */
        formGridBrand = function(id, ac, ele, load, loading, btn)
        {
         ...
         * @param string token
         */
        deleteGridBrand = function(id, name, url, token)
        {
