<div id="modal-profile-clients">
	<form id="form-profile-clients" method="POST" action="{{route('customers-perfil.store')}}" onsubmit="return false">
		@csrf
		<fieldset class="fieldset">
			...
			<p class="button-height inline-label">
				...
				<span class="number input">
					<button type="button" class="button number-down">-</button>
						<input type="text" id="percent_card" name="percent_card" value="" size="4" class="input-unstyled" data-number-options='{"min":0,"max":100,"increment":0.5,"shiftIncrement":5,"precision":0.25}'>
			...
			<p class="button-height inline-label">
				...
				<span class="number input">
					<button type="button" class="button number-down">-</button>
						<input type="text" id="percent_cash" name="percent_cash" value="" size="4" class="input-unstyled" data-number-options='{"min":0,"max":100,"increment":0.5,"shiftIncrement":5,"precision":0.25}'>
					<button type="button" class="button number-up">+</button>
				</span>
			...
			<p class="button-height inline-label">
				...
				<span class="number input margin-right">
					<button type="button" class="button number-down">-</button>
					<input type="text" name="order" value="" class="input-unstyled order" size="3">
					<button type="button" class="button number-up">+</button>
				</span>
				<span class="button-group">
