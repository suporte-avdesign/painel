...
use AVDPainel\Models\Admin\ConfigImageProduct as Model;
use AVDPainel\Interfaces\Admin\ConfigImageProductInterface;
    ...
    public function getAll($request)
    {
        ...
        if(!empty($query))
        {
            foreach ($query as $val){
                ...
                $edit   = "abreModal('Editar Padrão {$val->default}', '".route('images.edit', ['id' => $val->id])."', 'config-images', 2, 'true', 400, 300)";
                $delete = "deleteConfigImage('".route('images.destroy', ['id' => $val->id])."', '{$val->default}')";
