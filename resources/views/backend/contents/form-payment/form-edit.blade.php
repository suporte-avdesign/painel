<div id="modal-contents">
    <form id="form-contents" method="POST" action="{{route('form-payment.update', $data->id)}}" onsubmit="return false">
        ...
        <fieldset class="fieldset">
            ...
            <p class="button-height block-label">
                ...
                <textarea id="payment-edit" name="description" class="input full-width">{{$data->description}}</textarea>
            </p>
            ...
            <p class="button-height align-center">
                <span class="button-group">
                    ...
                    @can('contents-site-create')
                        <button id="btn-modal" onclick="formContents('update', 'contents', '{{route('form-payment.load')}}')" class="button blue-gradient">
