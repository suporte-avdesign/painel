...
use AVDPainel\Interfaces\Admin\ConfigImageProductInterface as InterModel;
...
class ConfigImageProductController extends AdminAjaxTablesController
{
    
    protected $ability = 'config-image-product';
    protected $view    = 'backend.config.images.products';
    protected $last_url;
    protected $messages;
    protected $confUser;
        ...
        InterConfigSystem $confUser)
    {
        ...
        $this->last_url   = array('last_url' => 'config/images');
        $this->messages   = array(
