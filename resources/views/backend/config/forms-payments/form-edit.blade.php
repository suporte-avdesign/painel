			...
			<p class="button-height inline-label">
				...
				<span class="button-group">
					<label for="active-1" class="button blue-active">
						<input type="radio" name="active" id="active-1" value="1" @if($data->active == 1) checked @endif>
						Ativo
					</label>
					<label for="active-0" class="button red-active">
						<input type="radio" name="active" id="active-0" value="0" @if($data->active == 0) checked @endif>
						Inativo
					</label>
				</span>
			</p>
