<div id="modal-contents">
    <form id="form-contents" method="POST" action="{{route('contract.update', $data->id)}}" onsubmit="return false">
            ...
            <p class="button-height align-center">
                <span class="button-group">
                    ...
                    @can('contents-site-create')
                        <button id="btn-modal" onclick="formContents('update', 'contents', '{{route('contract.load')}}')" class="button blue-gradient">
