<div id="modal-contents">
    <form id="form-contents" method="POST" action="{{route('delivery.store')}}" onsubmit="return false">
            ...
            <p class="button-height align-center">
                <span class="button-group">
                    ...
                    @can('contents-site-create')
                        <button id="btn-modal" onclick="formContents('create', 'contents', '{{route('delivery.load')}}')" class="button blue-gradient">
