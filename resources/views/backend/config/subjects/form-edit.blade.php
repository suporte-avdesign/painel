            ...
            <p class="button-height inline-label">
                ...
                <span class="button-group">
                    <label for="status-1" class="button blue-active">
                        <input type="radio" name="status" id="status-1" value="1" @if($data->status == 1) checked @endif>
                        Ativo
                    </label>
                    <label for="status-0" class="button red-active">
                        <input type="radio" name="status" id="status-0" value="0" @if($data->status == 0) checked @endif>
                        Inativo
                    </label>
                </span>
            </p>
