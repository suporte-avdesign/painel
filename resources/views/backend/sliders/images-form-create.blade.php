...
<div class="columns">
	<form id="form-image"  method="post" action="{{route($upload['type'].'-slider.store', $id)}}" class="columns" enctype="multipart/form-data">
	    ...
	    <div class="eight-columns">
	    	<p class="button-height">
				<input type="file" name="image" id="upload_file" value="" class="file" onchange="preview_image('{{$id}}', '70%');" multiple/>
			</p>
	    </div>
